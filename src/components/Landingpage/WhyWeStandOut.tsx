          ...
          >
            {benefits.map((benefit, i) => (
              ...
              >
                ...
                <span className="font-bold text-[#071520] text-sm">{benefit}</span>
              </motion.div>
            ))}
          </motion.div>
        </motion.div>
      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
        ...
        >
          ...
          <p className="md:text-lg xl:text-lg leading-relaxed text-gray-700 font-medium bg-gray-50 p-4 rounded-lg text-justify shadow-sm">
            ...
            automation to produce vehicles with unmatched precision, efficiency,
            and safety standards. Each process is designed for scalability and
