      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-12 relative z-10 py-14">
        ...
        >
          ...
          <motion.p
            ...
            variants={itemVariants}
          >
            ERP (Enterprise Resource Planning) is comprehensive business management software that 
            integrates your core processes into a single, unified system — dramatically improving 
            efficiency, accuracy, and strategic decision-making across your entire organization.
          </motion.p>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
            ...
            >
              ...
              <p className="md:text-lg leading-relaxed text-gray-700 font-medium bg-gray-50 text-justify">
                Unicorn ERP is an innovative enterprise resource planning system designed to unify all your 
                essential business operations into a single, scalable platform. It empowers organizations 
